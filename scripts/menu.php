    ...
    <div class="sidebar-collapse">
      ...
      //If the username is admin
		if ($rol == 'Administrador')
		{
			...
			echo '<li><a href="new-queestapasando.php?type=newimage&url=/apps/show_imagenes.php"><i class="fa fa-upload fa-3x"></i> Que esta Pasando</a></li>';
			echo '<li><a href="register.php?type=register&url=/apps/show_members.php"><i class="fa fa-user-plus fa-3x"></i> Agregar Usuario</a></li>';
