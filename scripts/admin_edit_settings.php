<?php
	...
	if (isset($_SESSION['username']) && $_SESSION['rol']=="Administrador") 
	{
		...
		?>
		<div class="adminsettings"><a href="edit_image?vid=<?php echo $picid; ?>&type=productedit&url=<?php echo $url; ?>&title=<?php echo $title; ?>">
			<img src="images/buttons/edit.png" alt="" width="35" height="35" border=0/><span>Editar</span></a>
            <a href="image_status?vid=<?php echo $picid; ?>&type=productdelete&newurl=''">
